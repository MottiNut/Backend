...
public class UserFactory {
    ...
    public Patient createPatient(UserId userId, Email email, Password password, String firstName,
                                 ...
                                 String allergies, String dietaryPreferences, String emergencyContact, String gender,
        ...
        return new Patient(userId, email, password, firstName, lastName, birthDate, phone,
                ...
                dietaryPreferences, emergencyContact, gender);
        // Nota: El paciente ya no usa profileImage aquí porque ya se maneja desde la clase User (opcional)
    }
    ...
    public Nutritionist createNutritionist(UserId userId, Email email, Password password,
        ...
        // Usamos LocalDate.now() como fecha de nacimiento por defecto ya que no viene del frontend
        // En un caso real, podrías querer hacer esto opcional o requerirlo desde el frontend
