...
public class AuthService {
    ...
    public Patient registerPatient(Email email, String plainPassword, String firstName,
        ...
        Patient patient = userFactory.createPatient(
                ...
                dietaryPreferences, emergencyContact, gender, profileImage, imageContentType
        );

        Patient savedPatient = (Patient) userRepository.save(patient);

        // Enviar verificación por email para pacientes
        verificationService.sendEmailVerification(savedPatient.getUserId());
